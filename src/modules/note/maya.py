...
class Xfuedu:
    ...
    def save_cookies(self, cookies, site):
        ...
        saved_cookies_path = os.path.join(
            cookies_path,
    ...
    async def download(self, url, filename):
        ...
        for cookie in cookies:
            ...
            ck = http.cookiejar.Cookie(
                ...
                comment=None,
                comment_url=None,
                rest=cookie,  # dict  eg: { "auth": "auth_value" }
                rfc2109=False,
            )
            print(cookie)
        ...
        opener.addheaders = [
            ...
            ('Cookies',
             "cdb_visitedfid=84D82; is_use_cookied=yes; is_use_cookiex=yes; cdb_sid=8DpX3P; cdb_oldtopics=D2302881D"
             ),
        ]
